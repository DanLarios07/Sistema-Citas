          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            <thead>
              <tr>
                ...
                <th class="center">Codigo de Cita</th>
            ...
            $query = mysqli_query($mysqli, "SELECT a.estado_cita, a.codigo_cita,a.fecha,a.codigo_cliente,a.observacion,b.codigo_cliente,b.primerNombre,b.segundoNombre,b.primerApellido,
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      <td width='120' class='center'>$data[codigo_cita]</td>
