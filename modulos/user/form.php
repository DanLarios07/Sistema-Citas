    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" method="POST" action="modulos/user/proses.php?act=insert" enctype="multipart/form-data">
            <div class="box-body">
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" method="POST" action="modulos/user/proses.php?act=update" enctype="multipart/form-data">
            <div class="box-body">
